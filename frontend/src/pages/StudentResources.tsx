    ...
    <div className="pt-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredResources.map((res) => (
          <Card key={res.id} className="group p-6 bg-gradient-to-br from-[var(--card-gradient-start)] to-[var(--card-gradient-end)] backdrop-blur-sm border-white/20 shadow-sm hover:shadow-md transition-all">
      ...
      {filteredResources.length === 0 && (
        <Card className="p-12 text-center bg-gradient-to-br from-[var(--card-gradient-start)] to-[var(--card-gradient-end)] backdrop-blur-sm border-white/20 shadow-sm transition-colors">
