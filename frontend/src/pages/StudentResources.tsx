    ...
    <div className="pt-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredResources.map((res) => (
          <Card key={res.id} className="p-6 border-gray-200 hover:shadow-lg transition-shadow bg-[var(--card)]">
      ...
      {filteredResources.length === 0 && (
        <Card className="p-12 border-gray-200 text-center bg-[var(--card)]">
