  ...
  return (
    <div className="pt-8 space-y-8">
      ...
      <div className="space-y-4">
        {documents.map((doc) => (
          <Card key={doc.id} className="group p-6 bg-gradient-to-br from-[var(--card-gradient-start)] to-[var(--card-gradient-end)] backdrop-blur-sm border-white/20 shadow-sm hover:shadow-md transition-all">
